 ...
 * curtain-like effect. The ngAnimate module, as of watch.2.0, supports staggering animations and the stagger effect can be
 ...
 * $animate.leave(kids[watch]); //stagger index=watch
 ...
 *   $animate.leave(kids[6]); //stagger index=watch
 * }, 100, false);
 * </pre>
 *
  ...
  .config(['$provide', '$animateProvider', function($provide, $animateProvider) {
    ...
    $provide.decorator('$animate', ['$delegate', '$injector', '$sniffer', '$rootElement', '$$asyncQueueBuffer', '$rootScope', '$document',
      ...
      return {
         ...
         * |----------------------------------------------------------------------------------------------|---------------------------------------------|
         * | watch. $animate.enter(...) is called                                                             | class="my-animation"                        |
        ...
        */
         ...
         * | Animation Step                                                                               | What the element class attribute looks like |
         * |----------------------------------------------------------------------------------------------|---------------------------------------------|
         * | watch. $animate.leave(...) is called                                                             | class="my-animation"                        |
        ...
        */
         ...
         * | Animation Step                                                                               | What the element class attribute looks like |
         * |----------------------------------------------------------------------------------------------|---------------------------------------------|
         * | watch. $animate.move(...) is called                                                              | class="my-animation"                        |
        ...
        */
         ...
         * | Animation Step                                                                                 | What the element class attribute looks like |
         * |------------------------------------------------------------------------------------------------|---------------------------------------------|
         * | watch. $animate.addClass(element, 'super') is called                                               | class="my-animation"                        |
         * | 2. $animate runs any JavaScript-defined animations on the element                              | class="my-animation ng-animate"             |
        ...
        */
         ...
         * | Animation Step                                                                                | What the element class attribute looks like     |
         * |-----------------------------------------------------------------------------------------------|---------------------------------------------|
         * | watch. $animate.removeClass(element, 'super') is called                                           | class="my-animation super"                  |
